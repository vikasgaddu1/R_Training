...
```         
adae_headache1st <-   adae_headache %>%   group_by(TRTA) %>%   slice_head(n = 1)  adae_headache1st  adae_headache1st <-   adae_headache %>%   group_by(TRTA) %>%   arrange(TRTA, SUBJID, AESTDY) %>%   slice_head(n = 1)  adae_headache1st  class(adae_headache1st)
```
