...
quiz(
  question(
    "Which of the following is a named vector?",
    type = "learnr_radio",
    ...
    answer(
      "named_vector <- c(g1 = 'hello', g2 = 'good-bye', g3 = 'aloha')",
      message = "This is a named vector as well, but it's not the only one."
    ),
    answer("All the above", correct = TRUE, message = "Correct! All of the examples are named vectors.")
  ),
  
  question(
    "In the expression a <- 237, the variable a is really a vector of length 1.",
    type = "learnr_radio",
  ...
  question(
    "What is the value of the variable exp_result from the equation exp_result <- 2 ^ 3?",
    type = "learnr_radio",
  ...
  question(
    "What is the value of the variable unknown_counts after running the code below?
...
question(
  "How many elements does the following vector contain?
...
question(
  ...
  type = "learnr_radio",
  answer("True", message = "It's actually the other way around! Check again."),
  answer("False", correct = TRUE, message = "Correct! The %/% operator returns the integer quotient, and the %% operator returns the remainder.")
),

question(
  "What does the class function print to the console for the code below?
...
question(
  "The & operator means the same thing in SAS and R.",
  type = "learnr_radio",
...
question(
  "What is the resulting value for the variable q2 below?
...
question(
  "A data frame has to contain at least two vectors.",
  type = "learnr_radio",
...
question(
  "How many elements will the vector vnumlt3 have?

vnums <- c(1,2,3,4,5)
vnumlt3 <- vnums[vnums < 3]",
type = "learnr_radio",
answer("3", message = "Remember, the condition vnums < 3 will select only elements less than 3."),
answer("2", correct = TRUE, message = "Correct! Only 1 and 2 are less than 3."),
answer("4", message = "The condition vnums < 3 will not include elements that are equal to or greater than 3."),
answer("0", message = "There are elements in vnums that satisfy the condition vnums < 3.")
),
question(
  "How many elements will the vector vnumlt3 have?
...
quiz(
  question("What does the print function print to the console for the code below?
...
print(tf)",
  ...
  question("What does the length function print to the console for the code below?
...
question("What is true given the following data frame named dfdemo and line of code?
...
question("What is the resulting value for the element named ETWO in the vector after running the code below?
