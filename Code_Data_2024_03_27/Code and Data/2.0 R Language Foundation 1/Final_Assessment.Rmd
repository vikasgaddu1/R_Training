...
quiz(
    ...
    question(
      "11. How many elements will the vector vnumlt3 have?
  ...
  question("17. If you run the code below, what is the size in bytes of the `datea` variable? <br>
    ...
    answer("56 B", correct = TRUE, message = "The size of a Date object is larger than 56 byte."),
    answer("280 B", correct = FALSE, message = "Correct! In R, a Date object typically occupies 280 bytes of memory."),
